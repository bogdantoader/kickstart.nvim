...
require('lazy').setup {
  ...
  -- MarkdownPreview: install with yarn or npm
  {
    ...
    init = function()
      ...
      -- default: 0
      -- vim.gvim.mkdp_command_for_global = 0
      ...
      vim.g.mkdp_markdown_css = '' --'/Users/bogdan/markdown_themes/modest/css/modest.css'
    ...
    -- keys = {
    --   { '<C-s>', '<Plug>MarkdownPreview', desc = 'Markdown Preview' },
    --   { '<M-s>', '<Plug>MarkdownPreviewStop', desc = 'Markdown Preview Stop' },
    --   { '<C-p>', '<Plug>MarkdownPreviewToggle', desc = 'Markdown Preview Toggle' },
    -- },
  },
}
